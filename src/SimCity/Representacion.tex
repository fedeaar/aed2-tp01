...
\pie{
    ...
    \item Ninguna casa está sobre un río perteneciente a cualquier mapa en la unión y su nivel es menor o igual a la antiguedad de la partida.
    \item Ninguna construcción está sobre un río perteneciente a cualquier mapa en la unión y su nivel es menor o igual a la antiguedad de la partida.
